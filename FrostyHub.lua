...
btnTpBase.Text = "Tp Base (necessário Resetar Para funcionar)"
...
player.CharacterAdded:Connect(function(char)
    ...
    -- Define posição inicial segura para Tp Base
...
-- Reseta o personagem do player **para o spawn normal** ao executar o script
